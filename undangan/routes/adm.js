...
router.get('/kepada/:kepada',(req,res,next)=>{
    const dataProperti = {
        ...
        teks8 :`
                    <p class="text-center font-kufi">كفى بسيدنا محمد صلى الله عليه وسلم أسوة وقدوة للناس في
                        جميع شؤونهم في الحياة</p>
                    <p class="text-center mt-4">"Cukuplah baginda nabi Muhammad SAW sebagai suritauladan dan
